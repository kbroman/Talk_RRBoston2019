...
\note{
  ...
  challenge is that there are folks from two institutiones. But even
...
\note{
  ...
  In the lower panel, we plot all of these inferred QTL (which stands
  for ``quantitative trait locus,'' a genetic locus that affects a
  quantitative trait) for about 100 or so traits. There are a lot of
